...
#pragma warning restore CS0660 // Type defines operator == or operator != but does not override Object.Equals(object o)}
    ...
    {
        public static Maybe<TClass> Factory<TClass>(this Maybe<TClass> maybe, TClass refValue) where TClass : class 
        {
            if (refValue == null)
                return Maybe<TClass>.None;

            return Maybe<TClass>.Some(refValue);
        }
    }
}
